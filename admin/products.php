        	...
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" name="product_desc" placeholder="Produit description"></textarea>
		        	</div>
        		</div>
            <div class="col-12">
              <div class="form-group">
                <label>Quantité de produit</label>
                <input type="number" name="product_qty" class="form-control" placeholder="Enter Quantité">
              </div>
            </div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Prix du produit</label>
		        		<input type="number" name="product_price" class="form-control" placeholder="Enter prix">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-product">Ajouter le produit</button>
        		</div>
        	</div>
          ...
          <div class="row">
           ...
           <div class="col-12">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Description du produit</label>
                <textarea class="form-control" name="e_product_desc" placeholder="Enter description"></textarea>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Quantité de produit</label>
                <input type="number" name="e_product_qty" class="form-control" placeholder="Enter Quantité">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Prix du produit</label>
                <input type="number" name="e_product_price" class="form-control" placeholder="Enter prix">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
